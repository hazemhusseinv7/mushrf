        ...
        >
          ...
          <div
            className={cn(
              ...
              "mx-auto" // remove max-w-7xl if you want the carousel to span the full width of its container
            )}
          >
    ...
    <>
          ...
          <div className="fixed inset-0 z-50 h-screen overflow-auto" dir="rtl">
            ...
            >
              <button
                ...
                onClick={handleClose}
              >
                <IconX className="size-5 text-neutral-100 dark:text-neutral-900" />
              </button>
              <motion.p
      ...
      >
        ...
        <BlurImage
          ...
          alt="Feature image"
          fill
          className="absolute inset-0 z-50 object-contain object-bottom"
        />
      </motion.button>
    </>
  );
